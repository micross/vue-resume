...
import { LeftNav } from "~/components/builder/sidebars/left-nav";
  ...
  return (
    <div class="max-h-screen">
      ...
      <div class="flex gap-6">
        <div class=" bg-background flex-none rounded-lg transition-[flex]">
          <LeftNav />
        </div>
        <div class="flex flex-1 justify-center gap-6">
          <div class=" bg-background flex-1 max-w-2xl transition-[flex]">
            <ResumeEditor />
          </div>
