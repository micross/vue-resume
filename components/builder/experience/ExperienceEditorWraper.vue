...
import { defaultExperience, type ExperienceSection, type Section } from "~/lib/schema";

export type Props<T extends Section> = {
    section: T;
};

const props = defineProps<Props<ExperienceSection>>()
...
<template>
    <main :class="mainClass">
        ...
        <ExperienceEditor v-for="(item, index) of section.items" :key="item.id" :item="item" :index="index" :section-id="props.section.id" />
