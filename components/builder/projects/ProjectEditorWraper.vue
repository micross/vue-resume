...
import { defaultProject, type ProjectSection, type Section } from "~/lib/schema";

export type Props<T extends Section> = {
    section: T;
};

const props = defineProps<Props<ProjectSection>>()
...
<template>
    <main :class="mainClass">
        ...
        <ProjectEditor v-for="(item, index) of section.items" :key="item.id" :item="item" :index="index" :section-id="props.section.id" />
