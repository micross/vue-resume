...
const Header = () => {
  ...
  const section = _.find(sections, { model: SectionModel.SUMMARY }) as SectionWithItem;
  ...
  return (
    <BaseSection<BasicsSchema> section={basics}>
      {(basics: BasicsSchema) => (
        <div>
          <div
            class="p-custom flex items-center space-x-8"
            style={{ backgroundColor: hexToRgb(primaryColor, 0.2) }}
          >
            <div class="space-y-3">
              <div>
                <div class="text-3xl font-bold">{basics.name}</div>
                <div class="text-base font-medium text-primary">
                  {basics.headline}
                </div>
              </div>

              <BaseSection<SummarySchema> section={section}>
  ...
  <div class="flex items-center gap-x-1.5">
    {Array.from({ length: 5 }).map((_, index) => (
      <div
        key={index}
        class={cn(
          "h-3 w-6 border-2 border-primary",
...
const Section = <T,>({
  ...
  return (
    <section id={section.model} class="grid">
      <h4 class="mb-2 border-b border-primary text-left font-bold text-primary">
        {section.name}
      </h4>
...
export const Leafish = () => {
  ...
  return (
    <div>
      ...
      <div class="p-custom grid grid-cols-2 items-start space-x-6">
